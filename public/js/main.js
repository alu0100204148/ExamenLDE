$(document).ready(function() {
  ...
  $('#PREVIEW').click(function() {
    ...
    n.document.write(res + '<br/><div style=\"text-align: center\"><button align=\"center\" id=\"results\" style=\"background-color:black; color:white; margin:3px; height:30px;\">Resultados</button></div><script type=\"text/javascript\" src=\"https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js\"></script><script type=\"text/javascript\">(function() {		$(\"#results\").click(function() {			var aux = 0;			var nPreg = 0;			$(\'input[value=\"1\"]\').each(function() {     		nPreg++;			});			$(\'input:checked\').each(function() {     		if($(this).attr(\"ver\") == \"V\"){     			aux++;     		}			});			alert(\"Ha acertado \" + aux.toString() + \" de \" + nPreg + \" preguntas.\");		});}());</script>');
  });
